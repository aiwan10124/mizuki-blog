...
export const siteConfig: SiteConfig = {
	title: "༺爱玩༻的小屋",
	subtitle: "欢迎光临？",
	siteURL: "https://blog.aiwan.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/aiwan10124",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/519421338",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "QQ",
					url: "https://qm.qq.com/q/ZjaZhFuzuK",
					external: true,
					icon: "mingcute:qq-fill",
				},
				{
					name: "QQ交流群",
					url: "https://qm.qq.com/q/oYMnCKxV7k",
					external: true,
					icon: "mingcute:qq-fill",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.aiwan.dpdns.org/",
		lang: SITE_LANG,
	},
	giscus: {
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	models: [
        "/pio/models/pio_default/model.json",
        "/pio/models/pio_pajamas/model.json",
        "/pio/models/pio_school/model.json"
    ],
	position: "left", // 模型位置
	width: 280, // 默认宽度
	height: 250, // 默认高度
	...
	dialog: {
		...
		home: "点击这里返回主页！", // 首页提示
		skin: ["想看新衣服吗？", "这套新装看起来很棒~"], // 换装提示
		close: "QWQ 下次见~", // 关闭提示
		link: "https://space.bilibili.com/519421338", // 关于链接
	},
};
